...
async function deployContracts() {
    ...
    let consumer1CoinUser = await createContractUser(consumer1Account, config.coinContract, coinContractMethods);

    let contractState = await consumer1CoinUser.get_contract_state({ args: {} });
    console.log(contractState);
    console.log(await masterAccount.getAccountBalance());
    console.log(await consumer1CoinUser.retrieve_dev_funds({ args: {} }));
    console.log(await masterAccount.getAccountBalance());

    let contractState2 = await consumer1CoinUser.get_contract_state({ args: {} });
    console.log(contractState2);
}
