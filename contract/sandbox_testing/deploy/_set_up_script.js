    ...
    switch (env) {
        case 'testnet':
            return {
                ...
                masterAccount: "coinflip-test.testnet",
                nftContract: "nft3.coinflip-test.testnet",
                coinContract: "coin3.coinflip-test.testnet",
                coinContractAccount: "coin-contract.coinflip-test.testnet",
                nftContractAccount: "nft-contract.coinflip-test.testnet",
                consumer1Account: "consumer1.coinflip-test.testnet",
                consumer2Account: "consumer2.coinflip-test.testnet",
                consumer3Account: "consumer3.coinflip-test.testnet",
                walletUrl: 'https://wallet.testnet.near.org',
                helperUrl: 'https://helper.testnet.near.org',
                keyPath: "/home/jveiga/.near-credentials/testnet/coinflip-test.testnet.json",
                keyPathCoin: "/home/jveiga/.near-credentials/testnet/coin-contract.coinflip-test.testnet.json",
                keyPathNft: "/home/jveiga/.near-credentials/testnet/nft-contract.coinflip-test.testnet.json",
                keyPath1: "/home/jveiga/.near-credentials/testnet/consumer1.coinflip-test.testnet.json",
                keyPath2: "/home/jveiga/.near-credentials/testnet/consumer2.coinflip-test.testnet.json",
                keyPath3: "/home/jveiga/.near-credentials/testnet/consumer3.coinflip-test.testnet.json"
            };
...
async function deployContracts() {
    ...
    let masterNftUser = await createContractUser(masterAccount, config.nftContract, nftContractMethods);
    let masterCoinUser = await createContractUser(masterAccount, config.coinContract, coinContractMethods);
