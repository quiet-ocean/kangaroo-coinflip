...
async function deployContracts() {
    ...
    let betSize = nearAPI.utils.format.parseNearAmount("50");
    console.log(await consumer1CoinUser.get_credits({ args: { account_id: consumer1Account.accountId } }));
    console.log(await consumer1CoinUser.play({ args: { _bet_type: true, bet_size: betSize } }));
    console.log(await consumer1CoinUser.get_credits({ args: { account_id: consumer1Account.accountId } }));
}
